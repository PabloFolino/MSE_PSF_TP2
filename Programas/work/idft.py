...
conejo=np.load("../Informe/Archivos de enunciados/fft_hjs.npy")[::1]
N=len(conejo)
def signal(f,n):
    return conejo[n]
#--------------------------------------
...
aniT=FuncAnimation(fig,updateT,N,init,interval=1 ,blit=False,repeat=True,cache_frame_data=False)
